...
pdftitle={Laboratorio IV Base de Datos II}, 
pdfsubject={https://github.com/ArlandBarrera/DBII{\textunderscore}Laboratorio{\textunderscore}4}]
{hyperref}
\usepackage{graphicx}
...
\input{2.Desarrollo/2.1.probs_resueltos.tex}
\section{Problemas propuestos}
\input{2.Desarrollo/2.2.probs_propuestos.tex}
\end{document}